...
on any computer that supports Java Runtime Version 1.6. This installer will attempt to download and install the \
Runtime from Sun Microsystems if necessary.$\r$\n$\r$\nYou should exit all Windows programs before continuing with \
this installation.  If you have any other programs running, please close them before proceeding with this \
