 ...
 * this software.
 * <p>
 * Fixed to eliminate warnings due to unchecked generic calls by Gene Ressler,
 * December 2009.
 * <p>
 * Credits:
...
public class Browser {
   ...
   */
  private static final boolean loadedWithoutErrors;
  ...
  static {
    ...
    loadedWithoutErrors = ok ? loadClasses() : false;
  }
    ...
    throws IOException 
  {
    ...
    Object locatedBrowser = locateBrowser();
    if (locatedBrowser == null) {
    ...
    switch (jvm) {
      case MRJ_2_0:
        ...
        try {
          ...
          putParameter.invoke(locatedBrowser, new Object[] { keyDirectObject, aeDesc });
          sendNoReply.invoke(locatedBrowser, new Object[] { });
        } 
        catch (InvocationTargetException ite) {
          ...
          locatedBrowser = null; // Ditto
        }
        break;

      case MRJ_2_1:
        Runtime.getRuntime().exec(new String[] { (String) locatedBrowser, url } );
        break;
      ...
      case WINDOWS_9x:
        ...
        Process process = Runtime.getRuntime().
                          exec(new String[] {(String) locatedBrowser,
      ...
      case OTHER:
        ...
        // Netscape
        String command = locatedBrowser.toString() + " -raise " +
