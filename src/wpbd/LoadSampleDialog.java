...
/**
 * Load sample dialog for the West Point Bridge Designer.
 * 
 * @author  de8827
 */
public class LoadSampleDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wpbd.WPBDApp.class).getContext().getResourceMap(LoadSampleDialog.class);
