...
public class Joint implements HotEditableItem<BridgePaintContext> {
     ...
     */
    public final static Image fixedJointImage = WPBDApp.getApplication().getImageResource("fixedjoint.png");
    public final static Image normalJointImage = WPBDApp.getApplication().getImageResource("normaljoint.png");
    public final static Image selectedJointImage = WPBDApp.getApplication().getImageResource("selectedjoint.png");
    public final static Image hotJointImage = WPBDApp.getApplication().getImageResource("hotjoint.png");
    public final static Image hotSelectedJointImage = WPBDApp.getApplication().getImageResource("hotselectedjoint.png");
    /**
    ...
    public String toString() {
        return WPBDApp.getResourceMap(Joint.class).getString(
