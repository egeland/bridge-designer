...
public class RecentFileManager implements ActionListener {
    ...
    public final void load() {
        final Vector<String> paths = (Vector<String>)WPBDApp.loadFromLocalStorage(recentFileStorageName);
        if (paths != null) {
     ...
     */
    public void save() {
        WPBDApp.saveToLocalStorage(recentPaths, recentFileStorageName);
    }
