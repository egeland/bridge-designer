    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        if (table != null) {
            ...
            if (!isPaintingForPrint && table.getRowSorter() != null) {
                ...
                if (sortOrder == null) {
                    sortIcon = WPBDApp.getApplication().getIconResource("sortnull.png");
                } else {
                    switch (sortOrder) {
                        case ASCENDING:
                            sortIcon = WPBDApp.getApplication().getIconResource("sortascending.png");
                            break;
                        case DESCENDING:
                            sortIcon = WPBDApp.getApplication().getIconResource("sortdescending.png");
                            break;
                        case UNSORTED:
                            sortIcon = WPBDApp.getApplication().getIconResource("sortneutral.png");
                            break;
                    }
                }
            }
