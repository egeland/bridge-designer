...
public class BridgeSketchModel {
    ...
    private void setNameFromResource(String key) {
        name = WPBDApp.getResourceMap(BridgeSketchModel.class).getString(key);
    }
    ...
    public static Object[] getList(DesignConditions conditions) {
        ...
        if (rtn == null) {
            ...
            list.add(WPBDApp.getResourceMap(BridgeSketchModel.class).getString("noTemplate.text"));
            ...
            ResourceMap resourceMap = WPBDApp.getResourceMap(BridgeSketchModel.class);
