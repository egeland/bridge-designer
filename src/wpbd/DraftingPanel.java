...
public class DraftingPanel extends JPanel implements RulerHost {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (selectedJoint != null) {
                ...
                if (bridge.moveJoint(selectedJoint, newLocation) == EditableBridgeModel.ADD_MEMBER_AT_MAX) {
                    ResourceMap resourceMap = WPBDApp.getResourceMap(DraftingPanel.class);
                    JOptionPane.showMessageDialog(WPBDApp.getFrame(),
    ...
    private static Cursor getCustomCursor(String fileName, int hotSpotX, int hotSpotY, String tip) {
        return Toolkit.getDefaultToolkit().createCustomCursor(
                WPBDApp.getApplication().getImageResource(fileName),
    ...
    public class Labels implements HotDraggableItem<BridgePaintContext> {
        ...
        private final String tip = WPBDApp.getResourceMap(DraftingPanel.class).getString("labelsTip.text");
    ...
    private class HorizontalGuide implements HotDraggableItem<BridgePaintContext> {
        ...
        private int yGrid;
        private final Cursor cursor = getCustomCursor("verticalsize.png", 15, 15, "Move Horizontal Guide");
        private final Image horizontalKnob = WPBDApp.getApplication().getImageResource("hguideknob.png");
        ...
        private final String tip = WPBDApp.getResourceMap(DraftingPanel.class).getString("horizontalGuideTip.text");
    ...
    private class VerticalGuide implements HotDraggableItem<BridgePaintContext> {
        ...
        private final Image verticalKnob = WPBDApp.getApplication().getImageResource("vguideknob.png");
        ...
        private final String tip = WPBDApp.getResourceMap(DraftingPanel.class).getString("verticalGuideTip.text");
