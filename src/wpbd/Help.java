...
/**
 * Consolidated support for access to the JavaHelp set for the West Point Bridge Designer.
 * 
...
public class Help {
    ...
    public static boolean initialize() {
        if (helpSet == null) {
            try {
                URL hsURL = WPBDApp.getApplication().getClass().getResource(helpsetFilename);
