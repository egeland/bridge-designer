...
public class BridgeBlueprintPrintable implements Printable {
    ...
    private Cell [] [] getMemberTableCells() {
        ResourceMap resourceMap = WPBDApp.getResourceMap(BridgeBlueprintPrintable.class);
    ...
    private int printStandardSheet(Graphics2D g, PageFormat pageFormat, int pageNo) {
        ...
        titleBlock.getCell(1, 2).setText(WPBDApp.getResourceMap(BridgeBlueprintPrintable.class).getString("titleBlockPage.text", pageNo));
