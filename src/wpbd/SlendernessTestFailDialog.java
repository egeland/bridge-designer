...
public class SlendernessTestFailDialog extends JDialog {
    ...
    private void update() {
        ...
        ImageIcon icon = WPBDApp.getApplication().getIconResource(key + ".gif");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wpbd.WPBDApp.class).getContext().getResourceMap(SlendernessTestFailDialog.class);
