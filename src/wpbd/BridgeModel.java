...
public class BridgeModel {
     ...
     */
    protected static final int version = 2011;
    /**
    ...
    public class Costs {
        ...
        String toTabDelimitedText() {
            ResourceMap resourceMap = WPBDApp.getResourceMap(CostReportTableModel.class);
    ...
    public String [] getNotes() {
        final ResourceMap resourceMap = WPBDApp.getResourceMap(BridgeModel.class);
