...
/**
 * Tip dialog for the West Point Bridge Designer.  Saves state in local storage so
...
public class TipDialog extends JDialog {
    ...
    public void showTip(boolean startup, int inc) {
        ResourceMap resourceMap = WPBDApp.getResourceMap(TipDialog.class);
        Object obj = WPBDApp.loadFromLocalStorage(showOnStartStorageName);
        if (obj != null) {
        ...
        obj = WPBDApp.loadFromLocalStorage(tipNumberStorageName);
        if (obj != null) {
            n = (Integer)obj;
        }
        ...
        WPBDApp.saveToLocalStorage(new Integer(n), tipNumberStorageName);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wpbd.WPBDApp.class).getContext().getResourceMap(TipDialog.class);
...
private void showTipsCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showTipsCheckActionPerformed
    ...
    if ( !WPBDApp.saveToLocalStorage(showOnStart, showOnStartStorageName) ) {
