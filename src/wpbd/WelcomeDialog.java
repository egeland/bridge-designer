...
/**
 * Welcome dialog for the West Point Bridge Designer.
 * 
...
public class WelcomeDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wpbd.WPBDApp.class).getContext().getResourceMap(WelcomeDialog.class);
