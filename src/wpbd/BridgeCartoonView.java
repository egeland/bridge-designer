...
public class BridgeCartoonView extends BridgeView {
     ...
     */
    protected final Image titleBlock = WPBDApp.getApplication().getImageResource("titleblock.png");
    /**
    ...
    private void paintMeasurements(Graphics2D g, ViewportTransform viewportTransform) {
        ResourceMap resourceMap = WPBDApp.getResourceMap(BridgeCartoonView.class);
