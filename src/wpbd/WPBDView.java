 ...
 */
public final class WPBDView extends FrameView
        implements 
    ...
    /**
     * Construct the West Point Bridge Designer main window view.
     * 
     * @param app West Point Bridge Designer application object.
     */
    public WPBDView(SingleFrameApplication app) {
        super(app);
    ...
    private void postInitComponents() {
        ...
        ActionMap actionMap = WPBDApp.getApplication().getContext().getActionMap(WPBDView.class, this);
        ...
        if (WPBDApp.getOS() == WPBDApp.MAC_OS_X) {
    ...
    private void print(boolean dialog) {
        ...
        PrinterUI.print(getFrame(), fileName, bridge, WPBDView.class, dialog);        
    }
    ...
    public boolean dispatchKeyEvent(KeyEvent e) {
        if (e.getID() == KeyEvent.KEY_PRESSED) {
            ...
            if (e.isControlDown() && e.isShiftDown() && (code == KeyEvent.VK_HOME || code == KeyEvent.VK_UP) && !isModalDialogVisible()) {
                ...
                keyCodeDialog.setLocationRelativeTo(WPBDApp.getFrame());
                final String keyCode = (String)WPBDApp.loadFromLocalStorage(keyCodeStorage);
    ...
    private void restoreFileChooserState() {
        final String path = (String) WPBDApp.loadFromLocalStorage(fileChooserPathStorage);
        if (path != null) {
    ...
    private void setStatusIcon() {
        ...
        statusLabel.setIcon(WPBDApp.getApplication().getIconResource(iconName));
    ...
    public void initComponentsPostShow() {
        ...
        if (WPBDApp.getFileName() == null) {
            tipDialog.showTip(true, 1);
            showWelcomeDialog();
        }
        else {
            try {
                File file = new File(WPBDApp.getFileName());
                bridge.read(file);
    ...
    private void checkHardware() {
        ...
        final Dimension storedScreenDim = (Dimension) WPBDApp.loadFromLocalStorage(screenDimensionStorage);
        WPBDApp.saveToLocalStorage(screenDim, screenDimensionStorage);
    ...
    private void showWelcomeDialog() {
        if (welcomeDialog == null) {
            JFrame mainFrame = WPBDApp.getApplication().getMainFrame();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(wpbd.WPBDApp.class).getContext().getResourceMap(WPBDView.class);
        fileMenu.setText(resourceMap.getString("fileMenu.text")); // NOI18N
        fileMenu.setName("fileMenu"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(wpbd.WPBDApp.class).getContext().getActionMap(WPBDView.class, this);
        ...
        memberListPanelLayout.setVerticalGroup(
            ...
            .addGroup(memberListPanelLayout.createSequentialGroup()
                .addComponent(loadTestResultsLabel)
                .addGap(8, 8, 8)
                .addComponent(memberScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 547, Short.MAX_VALUE))
        );
        ...
        memberDetailPanelLayout.setVerticalGroup(
            ...
            .addGroup(memberDetailPanelLayout.createSequentialGroup()
                ...
                .addGroup(memberDetailPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(memberSelecButtonPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(strengthCurveLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        designPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, designPanelLayout.createSequentialGroup()
                .addComponent(drawingPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 681, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        designPanelLayout.setVerticalGroup(
            designPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(drawingPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 603, Short.MAX_VALUE)
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cardPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 603, Short.MAX_VALUE))
        );
        ...
        toolsDialog.setIconImage(WPBDApp.getApplication().getImageResource("tools.png"));
        ...
        keyCodeDialog.setIconImage(WPBDApp.getApplication().getImageResource("appicon.png"));
...
private void keyCodeOkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keyCodeOkButtonActionPerformed
    if (querySaveIfDirty()) {
        ...
        WPBDApp.saveToLocalStorage(keyCodeTextField.getText(), keyCodeStorage);
...
private void keyCodeCancelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keyCodeCancelButtonActionPerformed
    ...
    public void open() {
        ...
        if (querySaveIfDirty()) {
            ...
            if (okCancel == JFileChooser.APPROVE_OPTION) {
                WPBDApp.saveToLocalStorage(fileChooser.getCurrentDirectory().getPath(), fileChooserPathStorage);
                try {
                    animation.stop();
                    recordRecentFileUse(oldFile);
                    bridge.read(fileChooser.getSelectedFile());
                    if (bridge.getDesignConditions().isFromKeyCode()) {
                        WPBDApp.saveToLocalStorage(bridge.getDesignConditions().getCodeString(), keyCodeStorage);
                    }
                    initializePostBridgeLoad();
                } catch (IOException e) {
                    selectCard(nullPanelCard);
    ...
    private void setLegacyGraphics()
    {
        ...
        WPBDApp.saveToLocalStorage(true, graphicsCapabilityStorage);
    }
    ...
    private void setStandardGraphics()
    {
        ...
        animation = flyThruAnimation;
        WPBDApp.saveToLocalStorage(false, graphicsCapabilityStorage);
    }
